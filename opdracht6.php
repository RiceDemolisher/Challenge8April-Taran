...
<h1>Opdracht 6</h1>
<p>Laatste uitbreiding op opdracht 4 en 5 (voor gevorderden): zorg nu dat het selecteren van een user ervoor zorgt dat
    de inputvelden automatisch worden gevuld met de reeds bestaande data, zodat we weten wat we aanpassen voordat we op
    submit klikken. Uiteraard, wederom, zonder de EDIT functionaliteit te verliezen.</p>
<div id="demo"></div>
